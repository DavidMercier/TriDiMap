...
handles.title_angleRot_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [0.02 0.81 0.11 0.02],...
    'String', 'Angle of rotation (°):',...
    'HorizontalAlignment', 'left');

handles.value_angleRot_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'Position', [0.135 0.81 0.03 0.02],...
    'String', '0',...
    'Callback', 'TriDiMap_runPlot');
...
handles.opendata_str_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'Position', [0.075 0.74 0.122 0.06],...
...
handles.slider_interpMap_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'slider',...
    'Min',minValI,'Max',maxValI,'Value',(minValI+maxValI)/2,...
...
handles.cb_errorMap_GUI = uicontrol('Parent', gcf,...
    ...
    'Value', 0,...
    'Callback', 'TriDiMap_error_plotting');
...
handles.cb_autoColorbar_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'checkbox',...
    'Position', [0.115 0.43 0.085 0.02],...
    'String', 'Auto scalebar',...
    'Value', 0,...
    'Callback', 'TriDiMap_runPlot');
...
handles.value_x_values_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'Position', [0.05 0.14 0.03 0.02],...
    'String', '');

handles.unit_x_values_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [0.08 0.14 0.03 0.02],...
    'String', '',...
    'HorizontalAlignment', 'left');
...
handles.value_z_values_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'Position', [0.15 0.13 0.03 0.02],...
    'String', '');

handles.unit_z_values_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [0.18 0.13 0.03 0.02],...
    'String', '',...
    'HorizontalAlignment', 'left');
