...
if module == 1
    ...
    handles.property_GUI = uicontrol('Parent', gcf,...
        ...
        'String', {'Elastic modulus';'Hardness';'E vs H';...
        'E_pdf';'H_pdf';'E_cdf';'H_cdf'},...
    ...
    coord_bg2 = [0.015 0.175 0.23 0.28];
    ...
    handles.cb_contourPlotMap_GUI = uicontrol('Parent', handles.bg_property_GUI_1_2, ...
        'Units', 'normalized',...
        'Style', 'checkbox',...
        'Position', [0.02 0.15 0.48 0.10],...
    ...
    handles.unit_transMap_GUI = uicontrol('Parent', handles.bg2_property_GUI_1_2, ...
        'Units', 'normalized',...
        'Style', 'text',...
        'Position', [0.65 0.25 0.08 0.08],...
        'String', 'GPa',...
        'HorizontalAlignment', 'center');
    
    %% Options of the plot
    handles.cb_log_plot_GUI = uicontrol('Parent', handles.bg2_property_GUI_1_2, ...
        'Units', 'normalized',...
        'Style', 'checkbox',...
        'Position', [0.02 0.14 0.20 0.08],...
        'String', 'Log',...
        'Value', 0,...
        'Callback', 'TriDiMap_runPlot');
    
    handles.cb_grid_plot_GUI = uicontrol('Parent', handles.bg2_property_GUI_1_2, ...
        'Units', 'normalized',...
        'Style', 'checkbox',...
        'Position', [0.25 0.14 0.20 0.08],...
        'String', 'Grid',...
        'Value', 0,...
        'Callback', 'TriDiMap_runPlot');
    ...
    handles.cb_markers_GUI = uicontrol('Parent', handles.bg2_property_GUI_1_2, ...
        'Units', 'normalized',...
        'Style', 'checkbox',...
        'Position', [0.48 0.14 0.20 0.08],...
        'String', 'Markers',...
        'Value', 0,...
        'Callback', 'TriDiMap_runPlot');
    
    handles.cb_MinMax_plot_GUI = uicontrol('Parent', handles.bg2_property_GUI_1_2, ...
        'Units', 'normalized',...
        'Style', 'checkbox',...
        'Position', [0.71 0.14 0.20 0.08],...
        'String', 'Min/Max',...
        'Value', 0,...
        'Callback', 'TriDiMap_runPlot');
    
    if ~strcmp(g.config.MatlabRelease, '(R2014b)')
        handles.cb_tickColorBar_GUI = uicontrol('Parent', handles.bg2_property_GUI_1_2, ...
            'Units', 'normalized',...
            'Style', 'checkbox',...
            'Position', [0.02 0.03 0.20 0.08],...
            'String', 'Ticks',...
            'Value', 0,...
            'Callback', 'TriDiMap_runPlot');
    end
