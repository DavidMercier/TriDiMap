...
if module == 1
    ...
    handles.property_GUI = uicontrol('Parent', gcf,...
        ...
        'String', {'Elastic modulus';'Hardness';'E vs H';'E_hist';'H_hist'},...
        'Value', 2, ...
        'Callback', 'TriDiMap_runPlot');
    
    handles.bg_property_GUI_1_2 = uibuttongroup('Visible','on',...
        'Position',[0.015 0.525 0.23 0.22]);
    ...
    % Pixelized data
    handles.cb_pixData_GUI = uicontrol('Parent', handles.bg_property_GUI_1_2,...
        'Units', 'normalized',...
        'Style', 'checkbox',...
        'Position', [0.02 0.68 0.48 0.10],...
    ...
    handles.cb_errorMap_GUI = uicontrol('Parent', handles.bg_property_GUI_1_2,...
        'Units', 'normalized',...
        'Style', 'checkbox',...
        'Position', [0.02 0.26 0.48 0.10],...
        'String', 'Plot of the error map',...
        'Value', 0,...
        'Callback', 'TriDiMap_runPlot');
    
    set(handles.unitLength_GUI ,'Callback', 'TriDiMap_runPlot');
    set(handles.unitProp_GUI ,'Callback', 'TriDiMap_runPlot');
    set(handles.value_deltaXindents_GUI ,'Callback', 'TriDiMap_runPlot');
    set(handles.value_deltaYindents_GUI ,'Callback', 'TriDiMap_runPlot');
    set(handles.value_MinXCrop_GUI ,'Callback', 'TriDiMap_runPlot');
    set(handles.value_MinYCrop_GUI ,'Callback', 'TriDiMap_runPlot');
    set(handles.value_MaxXCrop_GUI ,'Callback', 'TriDiMap_runPlot');
    set(handles.value_MaxYCrop_GUI ,'Callback', 'TriDiMap_runPlot');
    
    %% Buttons group for property 3
    handles.title_Hth_ValEH_GUI = uicontrol('Parent', handles.bg_property_GUI_3,...
        'Units', 'normalized',...
        'Style', 'text',...
        'Position', [0.02 0.80 0.18 0.10],...
        'String', 'H threshold:',...
        'HorizontalAlignment', 'left');
...
if module == 2
    ...
    set(handles.value_MinXCrop_GUI, 'Position', [0.10 0.77 0.02 0.02],'Callback', 'TriDiMap_runBin');
    set(handles.title_MaxXCrop_GUI, 'Position', [0.02 0.75 0.08 0.02]);
    set(handles.value_MaxXCrop_GUI, 'Position', [0.10 0.75 0.02 0.02],'Callback', 'TriDiMap_runBin');
    set(handles.title_MinYCrop_GUI, 'Position', [0.125 0.77 0.08 0.02]);
    set(handles.value_MinYCrop_GUI, 'Position', [0.21 0.77 0.02 0.02],'Callback', 'TriDiMap_runBin');
    set(handles.title_MaxYCrop_GUI, 'Position', [0.125 0.75 0.08 0.02]);
    set(handles.value_MaxYCrop_GUI, 'Position', [0.21 0.75 0.02 0.02],'Callback', 'TriDiMap_runBin');
