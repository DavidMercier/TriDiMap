...
if module == 1
    ...
    handles.title_MinValHist_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'text',...
        'Position', [0.12 0.76 0.04 0.02],...
        'String', 'Bin size:',...
        'HorizontalAlignment', 'left');
    
    handles.value_MinValHist_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'edit',...
        'Position', [0.165 0.76 0.03 0.02],...
        'String', '1', ...
        'Callback', 'TriDiMap_runPlot');
    
    handles.unit_MinValHist_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'text',...
        'Position', [0.195 0.76 0.03 0.02],...
        'String', 'GPa',...
        'HorizontalAlignment', 'center');
