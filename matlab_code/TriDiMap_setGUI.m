...
if module == 2
    ...
    handles.plotAllCritVal_GUI = uicontrol('Parent', gcf,...
        ...
        'String', 'Plot match = f(all threshold)',...
        'FontSize', 10,...
        'FontWeight','bold',...
        'BackgroundColor', [0.745 0.745 0.745],...
        'Visible', 'off', ...
