...
if module == 2
    ...
    %% Difference and ratios calculations
    handles.title_diffVal_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'text',...
        'Position', [0.02 0.36 0.11 0.02],...
        'String', 'Match between map and image',...
        'HorizontalAlignment', 'left');
    
    handles.value_diffVal_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'edit',...
        'Position', [0.135 0.36 0.03 0.02]);
    
    handles.unit_diffVal_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'text',...
        'Position', [0.170 0.36 0.03 0.02],...
        'String', '%',...
        'HorizontalAlignment', 'left');
    
    handles.title_ratioLow_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'text',...
        'Position', [0.02 0.32 0.11 0.02],...
        'String', 'Fraction of soft phase',...
        'HorizontalAlignment', 'left');
    
    handles.value_ratioLow_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'edit',...
        'Position', [0.135 0.32 0.03 0.02]);
    
    handles.unit_ratioLow_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'text',...
        'Position', [0.170 0.32 0.03 0.02],...
        'String', '%',...
        'HorizontalAlignment', 'left');
    
    handles.title_ratioHigh_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'text',...
        'Position', [0.02 0.28 0.11 0.02],...
        'String', 'Fraction of hard/stiff phase',...
        'HorizontalAlignment', 'left');
    
    handles.value_ratioHigh_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'edit',...
        'Position', [0.135 0.28 0.03 0.02]);
    
    handles.unit_ratioHigh_GUI = uicontrol('Parent', gcf,...
        'Units', 'normalized',...
        'Style', 'text',...
        'Position', [0.170 0.28 0.03 0.02],...
        'String', '%',...
        'HorizontalAlignment', 'left');
    
    %% Plot configuration
    handles.AxisPlot_GUI_1 = axes('Parent', gcf,...
        'Position', [0.33 0.10 0.15 0.75]);
    
    %% Plot configuration
    handles.AxisPlot_GUI_2 = axes('Parent', gcf,...
        'Position', [0.53 0.10 0.15 0.75]);
    
    %% Plot configuration
    handles.AxisPlot_GUI_3 = axes('Parent', gcf,...
        'Position', [0.73 0.10 0.15 0.75]);
