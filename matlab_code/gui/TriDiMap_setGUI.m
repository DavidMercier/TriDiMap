...
if module == 1
    ...
    handles.property_GUI = uicontrol('Parent', gcf,...
        ...
        'String', {'Elastic modulus (E) map';'Hardness (H) map';'E vs H';...
    ...
    handles.cb_GaussianPlot_GUI = uicontrol('Parent', handles.bg_property_GUI_6_7,...
        'Units', 'normalized',...
        'Style', 'checkbox',...
        'Position', [0.02 0.50 0.50 0.10],...
        'String', 'Gaussian CDF (mean value)',...
        'Value', 0,...
        'Callback', 'TriDiMap_runPlot');
    
    handles.cb_GaussianFit_GUI = uicontrol('Parent', handles.bg_property_GUI_6_7,...
        'Units', 'normalized',...
        'Style', 'checkbox',...
    ...
    handles.cb_WeibullFit_GUI = uicontrol('Parent', handles.bg_property_GUI_6_7,...
        'Units', 'normalized',...
        'Style', 'checkbox',...
        'Position', [0.02 0.30 0.50 0.10],...
        'String', 'Weibull fit',...
        'Value', 0,...
        'Callback', 'TriDiMap_runPlot');
    
    handles.cb_CdfFromPdf_GUI = uicontrol('Parent', handles.bg_property_GUI_6_7,...
        'Units', 'normalized',...
        'Style', 'checkbox',...
        'Position', [0.02 0.20 0.50 0.10],...
        'String', 'CDFs from PDFs fit',...
        'Value', 0,...
        'Callback', 'TriDiMap_runPlot');
    ...
    handles.pm_autoColorbar_GUI = uicontrol('Parent', handles.bg2_property_GUI_1_2, ...
        'Units', 'normalized',...
        'Style', 'popupmenu',...
        'Position', [0.02 0.78 0.40 0.08],...
        'String', {'Auto colorbar';'Manual';'Colorbar from PDF fit'},...
        'Value', 1,...
        'Callback', 'TriDiMap_runPlot');
