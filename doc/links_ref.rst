...
* `PopIn <https://github.com/DavidMercier/PopIn>`_ / `PopIn Documentation <https://popin.readthedocs.io/en/latest/>`_

Links about (nano)indentation
###############################
* `SF2M - Groupe Indentation. <https://sf2m.fr/commissions-thematiques/commission-indentation/>`_
...
* `Amanieu H.Y. et al., "Mechanical property measurements of heterogeneous materials by selective nanoindentation: Application to LiMn2O4 cathode" (2014). <https://doi.org/10.1016/j.msea.2013.11.04>`_
...
* `Besharatloo H. et al., "Small-scale mechanical properties of constitutive phases within a polycrystalline cubic boron nitride composite" (2019). <https://doi.org/10.1016/j.jeurceramsoc.2019.08.023>`_
...
Colormap
############################################
* `Matlab Colormap. <https://fr.mathworks.com/help/matlab/ref/colormap.html>`_
